...
| Metrik | Değer |
|--------|-------|
| **Sensör Okuma** | 100Hz (BME280), 1000Hz (BMI088) |
| **Task Periyotları** | 10ms (sensor/fusion), 100ms (flight/log) |
| **Telemetri Rate** | 10Hz (LoRa) |
| **SD Yazma Hızı** | ~500 KB/s |
| **CPU Kullanımı** | ~60% (peak) |
| **RAM Kullanımı** | ~80KB / 128KB |
| **Flash Kullanımı** | ~200KB / 512KB |
...
- [ ] Sensör kalibrasyonu yapıldı (SIT mode)
- [ ] Algoritma testleri başarılı (SUT mode)
- [ ] SD kart formatlandı ve test edildi
- [ ] LoRa iletişim menzil testi yapıldı
- [ ] Battery voltaj kontrol edildi
- [ ] Firmware son versiyona güncellendi
- [ ] Backup firmware hazır

### Post-flight Analiz
1. SD karttan log dosyasını kopyalayın
2. LoRa telemetri verilerini toplayın
3. `data_logger` ile CSV'ye çevirin
4. Python ile grafik analizi yapın
5. Event timing'lerini doğrulayın

---

<div align="center">

**SKYRTOS** - Teknofest Roket Yarışması için geliştirilmiştir 🚀
